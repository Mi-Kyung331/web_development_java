...
/*
    Map
        특징 :
            ...
            - 키는 중복을 허용하지 않으며, 값은 중복이 가능합니다. -> JSON이라는 형태가 가장 유사하기 때문
...
import c20_collections.students.Student;
...
public class StringMap {
    public static void main(String[] args) {
        ...
        // Set에서 List로 전홤 -> 추후 가장 중요한 개념 중 하나입니다.
        ...
        // Value 컬렉션 출력 -> <> 내부에 Value의 자료형을 넣으셔야 합니다.
