...
/*
    ...
    1. Java Collection Framework란?
        ...
        컬렉션 프레임워크를 사용하면 다양한 자료구조를 쉽게 구현하고,
        데이터를 추가, 삭제, 정렬, 검색 등의 작업을 감편하게 수행 가능.
    ...
    3. Java Collection 구조
        ...
        이후 부분은 List는 StrightList.java에, Set은 StringSet.java에 서술합니다.

    List - 데이터를 순차적으로 저장하며, 인덱스(index)를 사용해 요소(element)를 관리
         - 중복 데이터를 허용

         구현체 :
            ArrayList : 내부적으로 배열은 사용하며, 조회 속도가 빠름
...
public class StringList {
    public static void main(String[] args) {
        ...
        // List의 출력 - Array.toString()을 쓸 필요가 없습니다.
        ...
        System.out.println("삭제 후 전체 리스트 : " + strList);
        // 검색과 마찬가지로 일부 문자열로는 py가 포함된 요소가 삭제된다거나,
        // 혹은 py 문자열이 삭제 되어서 thon만 남는다거나 하는 일은 없습니다.
