...
//        checkFlag2 = true;      // 오류가 발생함을 확인
        ...
        // 추후 해당 변수에 값을 재대입하는 경우에는 변수명 = (바뀐)값; 형태로 작성

        // 2. 문자 자료형 변수
//        char name1 = '강';     // 문자를 입력할 때는 작은 따옴표(')로 감싼다
//        char name2 = '미';     // 문자(character) : 알파벳 / 한글 / 숫자 하나
//        char name3 = '경';
//
...
//        System.out.println("" + name1 + name2 + name3); // java의 sout의 경우 맨 앞의 자료형을 따라감
        // 즉, 큰 따옴표로 시작했을 경우 () 내에 있는 전체 자료형을 문자열로 보기 때문에 "강미경" 전체가 출력됨

        /*
        name1, name2, name3에 여러분의 이름을 한 글자씩 재대입하고(나는 이미 했으니까 강사님 이름인 안근수로),
...
//        String width3 = "300";
//        String width4 = "400";
//        System.out.println(width3 + width4);    // 문자끼리는 연산이 안되고, 나열만 가능 > c01에서 수업
//        System.out.println(width1 + width3);    // 정수 + 문자열 = 문자열로 나열 100300
//        System.out.println(width4 + width2);    // 문자열 + 정수 = 문자열로 나열 400200

        // java17 버전 이후 : 여러줄에 걸친 데이터를 하나의 변수에 대입 가능 큰따옴표 세개를 사용함
//        String introduction = """
//                안근수
//                영어교육과
//                코리아it아카데미 웹 강사
...
//        System.out.println(introduction2);
        ...
        // 3-2.
//        int longNumber = 123456789123456789;      > 오류발생 : int가 포함할 수 있는 자릿수를 벗어남
...
//        System.out.println(dotZero);
        ...
        // 5. 상수
        // final 자료형 변수명 = 데이터
        final String FILE_PATH = "c://kangmikung_java";
        // 상수의 경우에는 변수명을 대문자로 작성
...
//            EXAMPLE_OF_FINAL = "이렇게 바꾸겠습니다."; > 오류발생  // 상수의 재대입은 불가능 > 3. 참조
