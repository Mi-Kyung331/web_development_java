...
/*
    ...
    싱글톤 패턴의 단점 :
        ...
        2. 의존성 숨김 : 싱글톤을 남용하면 클래스 간의 의존성을 추적하기 어려울 수 있음 -> 신중하게 사용하세요.

        Samsung.java 클래스 / SmartPhone.java 클래스를 생성하시오
 */
...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        // 주소값이 아니라 필드가 다 튀어나올까요?   -> SmartPhone 클래스의 @ToString dosjxpdltus Eoansdp
