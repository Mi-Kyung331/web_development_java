package c18_static.singleton.databasses;

public class DatabaseMain {
    public static void main(String[] args) {

        // DataConnection 객체는 여기서 만들지 않습니다.
        // 그 이유는 무엇일까요? -> DataMaganer.java에 DatabaseConnection 객체를 하나 만들어 내는
        ...
        // dataManager2 객체 생성 하시고 performDatabaseOperations()이것을 실행시킨 결과를
        // 콘솔 창에 띄워두세요.
        ...
        /*
            ...
            이유는?
            dataManager1을 생성했을 때 DataConnection의 객체를 만들게 되는데, 이 때 싱글톤으로 작성했기 때문에
            dataManager2 객체를 생성한다고 하더라도 기존의 DatabaseConnection 객체를 사용함.
            그 결과 DatabaseConnection의 생성자는 한 번만 호출 됨
