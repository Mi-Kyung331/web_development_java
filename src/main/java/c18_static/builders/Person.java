...
public class Person {
    ...
    // Person 클래스의 내부 클래스로 Builder 클래스 정의할겁니다.
    public static class Builder {
        // Builder 클래스 내부에 필드 선언
        private String name;
//        private final String name; // -> fianl을 적용했을 때와 아닐 때의 예시를 둘 다 표시해두었습니다.
        private int age;
        private String address;
...
//        }
    ...
    // 이 이하의 코드가 불편해서 빌터 패던이 나왔다고 보면 됩니다.
