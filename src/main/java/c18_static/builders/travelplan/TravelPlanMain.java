...
/*
    ...
    지시사항
        ...
        2. 위의 속성의 예시에 적어둔 테이터를 기준으로 객체를 생성할 것
...
public class TravelPlanMain {
    public static void main(String[] args) {
        ...
        TravelPlan travelPlan1 = TravelPlan.builder()       // 여기서는 new가 안들어갔었습니다.
                .destination("파리")                        // 이유는 Builder에서 필수 생성자가 없었기 때문입니다.
        ...
        TravelPlanLombok travelPlanLombok1 = new TravelPlanLombok.Builder("런던", "2024-01-01")
                .build();   // 하지만 TravelPlanLombok과 Builder에서 final로 지정한 속성 때문에
                            // Builder의 생성2자를 이용하는 경우 new와 .Builder(인수들)로 대문자 Builder를 사용해야합니다.
        System.out.println(travelPlanLombok1);
