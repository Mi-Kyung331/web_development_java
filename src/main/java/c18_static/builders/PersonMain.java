...
/*
    1. 빌더 패턴(Builder Patton)이란?
        ...
        2. 빌더 패턴이 생기게 된 원인
            1. 복잡한 생성자 문제
                객체와 필드가 많아질 수록 생성자의 파라미터 수도 늘어남.
                - Person.java 주석 확인
...
public class PersonMain {
    public static void main(String[] args) {
        // Person.java에서 정의한 Builder Patton을 이용하여 객체를 생성하는 방법
        Person person1 = new Person.Builder("김일")   // private final String name으로 정의한 거 기억하세요
                .build();
        ...
        // 기존 생성 방법의 경우
//        Person person1 = new Person("김일");    -> 생성자를 private으로 했기 때문에 불가능 합니다.
