...
/*
    ...
    실행 예
    Products(productsName=Laptop, productInfo=Intel i7, 16GB RAM, 512GB SSD)
    Products(productsName=SmartPhone, productInfo=799.99)
    Products(productsName=Available, productInfo=true)
 */
...
public class ProductsController {
    public static void main(String[] args) {
        ...
        // int > Integer처럼 double 자료형 역시 클래스화 되어 있는 Double이 있습니다.
