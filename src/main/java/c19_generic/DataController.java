...
/*
    ...
    제네릭의 개념 및 정의
        ...
        타입 매개변수(Type Parameter) : 클래스나 메서드에서 사용할 실제 타입을 '대신하여' 사용하는 매개변수
            일반적으로 알파벳 대문자 한 글자로 표현함. 주로 T, E, K, V등이 자주 사용됨
            ...
            다 끝나신 분들은
            Products.java
            ProductsController.java 파일 만드세요 -> main
 */
...
public class DataController {
    public static void main(String[] args) {
        ...
        // ResponseData 클래스를 확인해보면 T data로 정의한 필가 있는데, 이름
        ...
        // now는 객체라는 점을 13번 라인에서 확일 할 수 있습니다.
        // ResponseData 클래스에 @Data를 입력했기 때문에 @ToString이 포함되어 있습니다.
        // 그래서 now가 줄력 가능합니다. @Data가 빠져
    }
}
