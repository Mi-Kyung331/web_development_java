...
public class Person {
    ...
    //      대신 필드오 ㅏ동일한 자료형의 return 값이 요구됨 -> void가 아니다.
    ...
    public void setAge(int age) {
        ...
        // 조건문을 적용 해서 0 이상의 값만 입력이 가능하게끔 코드를 작성하면 됩니다.
        // 시작하세요.
        // 다 하신 분들은 150 미만의 값만 입력되게끔 코드를 추가
//        if (age >= 0) {
//            // 중첩 if 문 사용
//            if (age < 150) {
//            this.age = age;
...
//            }
            ...
            //      > 여기에 while문을 붙여 올바른 값만 입력하게끔 코드 작성
//            if (age >= 0 && age < 150) {
//                this.age = age;
//            } else {
//                System.out.println("다시 입력하세요.");
...
//        age >=0 && age < 150 범위의 반대는 어떻게 될까? -> 값이 잘못되었을 때
        // 반복문이 실행되어야 하므로 반대 범위를 산출해냈음.
        while(age < 0 || age >= 150) {
            System.out.print("나이는 이상 150 미만이어야 합니다. 다시 입력하세요. >>> ");
            age = scanner.nextInt();    // argument로 age를 받았지만,
                                        // 값이 적절하지 않기 때문에 재입력을 받아 age에 '재'대입하는 과정이 필요.
        }
        this.age = age;
