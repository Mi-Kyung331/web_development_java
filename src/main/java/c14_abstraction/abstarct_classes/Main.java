package c14_abstraction.abstarct_classes;
/*
    abstract : 추상적인
    ...
    생성할 클래스 목록
    Factory             > 얘가 디자인 패턴 중 Factory 형태 아님
     ㄴ 수퍼 클래스 (부모 클래스) - 좀 더 광범위한 범위를 가진 클래스가 부모 클래스가 될 수 있음
    PhoneFactory        > Factory 상속 받으세요
    TabletFactory       > Factory 상속 받으세요
 */
