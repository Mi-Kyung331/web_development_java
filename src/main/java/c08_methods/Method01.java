...
/*
    ...
    함수와 매서드가 동일한 개념이라면 왜 용어를 분리하는가?
        ...
        > 자바의 경우는 모든 함수들이 특정 클래스에 종속되어있기 때문에 전부 다 메서드에 해당함.
    ...
    예를 들어, '사진을 찍는다.'라는 행위에 대해서 생각해 보면
        1) 주머니에서 폰을 꺼내고,
        2) 잠금화면을 풀고,
        3) 카메라를 켜고,
...
//        System.out.println(call4(2024, 11, 29));  // 실행 방법 1 : 출력문 내에 바로 함수 호출
        // 변수 선언 및 초기화  > 매서드의 return값을 todayDate에 대입
