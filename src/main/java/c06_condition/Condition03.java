...
public class Condition03 {
    public static void main(String[] args) {
        /*
            삼향 연산자
            정의 : 조건식을 평가하여 true 혹은 false 여부에 따라 두 가지 실행문 중
            하나를 선택적으로 실행하는 구문
...
//        } else {    // else는 if가 false일 때 실행되는 최종 조건문이기 때문에 조건식이 포함되지 않음
//            // > num이 0 미만인 경우 // num < 0
//            System.out.println("num은 음수입니다.");
//        }
        // 이상의 if - else 구문을 3향 연산자로 바꾸시오.

        exampleSentence = num >= 0 ? "num은 양수이거나 0입니다." : "num은 음수입니다."; // 삼향연산자 조건식 시작
