...
public class TipCalc {
    public static void main(String[] args) {
        ...
        // 7. 5의 결과괎 / 6의 결과값 = 팁을 포함한 더치페이 가격이 산출됨.
//        int foodPrice;
//        int percent;
...
//        // percent / 100을 할 경우 0.1이 나오면 int가 아닌 double이기 때문에 연산 안됨
...
//        System.out.println("1인당 지불해야 하는 금액은 " + pricePerPerson + "원입니다.");
        ...
        int persons;
        double pricePersons;
        //로고 변수 선언 및 초기화 // 다중라인 데이터의 경우 큰 따옴표 세 개 > String
        String logo = """
                 /$$$$$$$$ /$$$$$$ /$$$$$$$   /$$$$$$   /$$$$$$  /$$        /$$$$$$   /$$$$$$  /$$$$$$$$ /$$$$$$  /$$$$$$$\s
                |__  $$__/|_  $$_/| $$__  $$ /$$__  $$ /$$__  $$| $$       /$$__  $$ /$$__  $$|__  $$__//$$__  $$| $$__  $$
                   ...
                   | $$     | $$  | $$      | $$    $$| $$  | $$| $$      | $$    $$| $$  | $$   | $$  | $$  | $$| $$  \\ $$
                   | $$    /$$$$$$| $$      |  $$$$$$/| $$  | $$| $$$$$$$$|  $$$$$$/| $$  | $$   | $$  |  $$$$$$/| $$  | $$
                   |__/   |______/|__/       \\______/ |__/  |__/|________/ \\______/ |__/  |__/   |__/   \\______/ |__/  |__/
                                                                                                                          \s
                                                                                                                          \s
                                                                                                                          \s
                """;
...
//       totalPrice = (foodPrice + (foodPrice*percentModified));
       ...
       totalPrice = foodPrice * (1 + (percentModified));
        ...
        pricePersons = totalPrice / persons;
        // 변수 선언을 해당 위치에서 한 이유는 형변환을 위해서는 반드시 pricePerPerson이 초기화 되어야 하기 때문
        int pricePersonsInt = (int) pricePersons;
        System.out.println("1인당 지불해야 하는 금액은 " + pricePersonsInt + "원입니다.");
    }
}
