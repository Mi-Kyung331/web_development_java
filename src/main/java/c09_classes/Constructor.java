...
/*
    ...
    특징
    1. 클래스의 이름고 ㅏ생성자 이름은 동일하다. (즉, 다른 메서드들과 달리 대문자로 시작한다.)
...
public class Constructor {
    ...
    // 이후 ConstructorMain.java에서 Constructor constructor = new Constructor("김일");을 통해 객체를 생성하세요.
    ...
    // 콘솔창에 Constructor4의 name과 num을 출력하세요
        ...
        // field들이 전부 출력 될 수 있는 method를 정의 해야만 함.
